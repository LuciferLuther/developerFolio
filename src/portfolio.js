...
const greeting = {
  ...
  subTitle: emoji(
    ["Im a Mechatronics Engineer & an enthusiastic Data Scientist 👨‍🔬📊",'Who is passionate about exploring the wonders of Data Science, Machine Learning & AI with the aim of making the world a better place one day 🌟']
  ),
  resumeLink:
